...
# $priorCsv = "terra_probe_results\probe_baselines\$trainDomain\cross_target_summary\teacher_mean_metrics_terra_incognita_$trainDomain.csv"

# if (-not (Test-Path $priorCsv)) {
#     throw "Missing global prior CSV: $priorCsv"
# }

# foreach ($targetDomain in $targetDomains) {

#     Write-Host "======================================="
#     Write-Host "RankMe DELTA: $trainDomain -> $targetDomain"
#     Write-Host "======================================="

#     $argsList = @()

#     foreach ($t in $teachers) {
#         $feat = "terra_probe_results\terra_incognita\$trainDomain\$t\features_$targetDomain.npz"
#         $probe = "terra_probe_results\terra_incognita\$trainDomain\$t\probe_outputs_$targetDomain.npz"

#         if (-not (Test-Path $feat)) {
#             throw "Missing feature file: $feat"
#         }

#         if (-not (Test-Path $probe)) {
#             throw "Missing probe file: $probe"
#         }
...
#     python scripts\rankme_probe_router.py `
#         @argsList `
#         --outdir "terra_probe_results\rankme_delta\$trainDomain\$targetDomain" `
#         --tag "terra_incognita_${trainDomain}_${targetDomain}_delta" `
...
#         --ensemble_deviation_lambda 0.15 `
